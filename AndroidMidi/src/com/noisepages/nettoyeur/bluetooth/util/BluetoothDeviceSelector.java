...
public abstract class BluetoothDeviceSelector extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if (!devices.isEmpty()) {
			builder.setTitle(R.string.title_select_bluetooth_device).setItems(deviceLabels, new DialogInterface.OnClickListener() {
			...
			builder.setTitle(R.string.title_no_paired_devices).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
