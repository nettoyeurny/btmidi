...
package com.noisepages.nettoyeur.bluetooth.midi.pd;
 ...
 */
public class PdMidiBridge implements BluetoothMidiReceiver, PdMidiReceiver {
	...
	public static void establishMidiBridge(BluetoothMidiService service, BluetoothSppObserver observer) throws IOException {
		PdMidiBridge bridge = new PdMidiBridge(service, observer);
		service.init(bridge);
	...
	private PdMidiBridge(BluetoothMidiService service, BluetoothSppObserver observer) {
